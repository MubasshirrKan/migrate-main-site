...
export default function ContactSection() {
  return (
    <section className="relative min-h-screen bg-black py-24 md:py-32 flex items-center justify-center overflow-hidden">
      {/* Background & Gradients */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_var(--tw-gradient-stops))] from-blue-900/20 via-black to-black opacity-60 z-0" />
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-white/50 text-lg leading-relaxed font-light mb-12 max-w-md">
              Whether you have questions about our verification process or need assistance with your documents, our expert team is here to help you every step of the way.
            </p>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex items-center gap-4 group cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-white/80 group-hover:text-white transition-colors">hello@aifilecheck.edu</p>
                </div>
              </div>
            ...
            <div className="relative w-full max-w-md p-10 md:p-14 rounded-[2.5rem] bg-[#050505] border border-[#25D366]/20 backdrop-blur-2xl shadow-[0_0_80px_rgba(37,211,102,0.1),0_0_40px_rgba(37,211,102,0.05)_inset] overflow-hidden group">
              ...
              <div className="relative z-10 flex flex-col items-center text-center">
                ...
                <p className="text-white/50 text-base font-light mb-10 leading-relaxed">
                  Skip the forms. Chat directly with our admission experts for instant answers and personalized guidance.
                </p>

                <button 
                  onClick={() => window.open('https://wa.me/1234567890', '_blank')}
                  className="relative w-full px-8 py-5 rounded-2xl group/btn outline-none overflow-hidden transition-all hover:scale-[1.02] active:scale-[0.98] bg-[#25D366] border border-[#128C7E] flex items-center justify-center shadow-[0_0_30px_rgba(37,211,102,0.4)]"
                >
                ...
                <p className="mt-4 text-white/30 text-xs font-mono tracking-widest uppercase">
                  Typically replies in <span className="text-[#25D366]/80 font-bold">5 minutes</span>
                </p>
              </div>
            </div>
          </motion.div>
